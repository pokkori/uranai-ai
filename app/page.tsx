      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { name: "スタンダード", price: "¥980/月", limit: "毎日鑑定可能", features: ["全鑑定タイプ", "毎日の運勢", "相性診断"], url: "https://gumroad.com/l/REPLACE_STD", highlight: true },
            { name: "ビジネス", price: "¥2,980/月", limit: "無制限", features: ["スタンダードの全機能", "月運・年運鑑定", "優先サポート"], url: "https://gumroad.com/l/REPLACE_PRE", highlight: false },
          ].map((plan) => (
