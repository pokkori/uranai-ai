...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-purple-950 text-white px-4 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-purple-200 leading-relaxed">
          <section>
            <h2 className="text-white font-bold mb-2">第1条（適用）</h2>
            <p>占いAI（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは本規約に同意の上、本サービスをご利用ください。</p>
          </section>
          <section>
